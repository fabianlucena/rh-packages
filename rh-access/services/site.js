...
import {SessionSiteService} from './session_site.js';
...
export class SiteService {
    ...
    async getForSessionIdOrDefault(sessionId, options) {
        let site = await SiteService.getForSessionId(sessionId, {...options, skipThroughAssociationAttributes: true, skipNoRowsError: true});
        if (site)
            return site;
