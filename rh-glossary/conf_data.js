...
export const data = {
  ...
  menuItems: [
    ...
    { name: 'glossary.get',      parent: 'glossary.admin', ownerModule: name, permissions: 'glossary.get',  label: loc._cf('menu', 'Glossarys'),  isTranslatable: true, translationContext: 'menu', icon: 'glossary',   action: 'grid', service: 'glossary' },
