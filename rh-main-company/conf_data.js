...
export const data = {
    ...
    permissions: [        
        {name: 'main-company.get',    title: loc._cf('permission', 'Get main companies'),    isTranslatable: true, roles: 'mainCompanyManager',  ownerModule: name, menuItem: {label: loc._cf('mainCompany', 'Main companies'), isTranslatable: true, translationContext: 'mainCompany', action: 'grid', service: 'main-company'}},
