...
export const conf = {
    ...
    data: {
        ...
        permissions: {
            ...
            'user.get':       {title: loc._f('Get user(s)'),           type: 'private',   roles: 'userManager', ownerModule: name, menuItem: {name: 'user.get',       label: loc._f('Users'),       parent: 'session-menu', action: 'form',    service: 'user'}},
            ...
            'session.get':    {title: loc._f('Get session(s)'),        type: 'private',   roles: 'userManager', ownerModule: name, menuItem: {name: 'session.get',    label: loc._f('Sessions'),    parent: 'session-menu', action: 'form',    service: 'session'}},
            'session.delete': {title: loc._f('Delete session'),        type: 'private',   roles: 'userManager', ownerModule: name,},
            'ownsession.get': {title: loc._f('Get own sessions only'), type: 'global',                          ownerModule: name, menuItem: {name: 'ownsession.get', label: loc._f('My sessions'), parent: 'session-menu', action: 'form',    service: 'session'}},
        }
    },
};
