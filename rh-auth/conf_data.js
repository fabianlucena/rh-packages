...
export const data = {
    ...
    permissions: [
        ...
        {name: 'logout',              title: loc._cf('premission', 'Logout'),                isTranslatable: true, roles: 'user',        ownerModule: name, menuItem: {label: loc._cf('menu', 'Logout'),                                   parent: 'session-menu',   action: 'apiCall', service: 'logout',           method: 'post', onSuccess: '{clearBearerAuthorization: true, clearApiData: true, reloadMenu: true}', redirectTo: '/'}},
