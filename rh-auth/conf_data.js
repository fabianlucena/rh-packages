...
export const data = {
    ...
    permissions: [
        ...
        {name: 'logout',              title: loc._cf('premission', 'Logout'),                isTranslatable: true, roles: 'user',        ownerModule: name, menuItem: {label: loc._cf('menu', 'Logout'),                                   icon: 'logout',          parent: 'session-menu',   action: 'apiCall', service: 'logout',           method: 'post', onSuccess: {clearBearerAuthorization: true, clearApiData: true, reloadMenu: true}, redirectTo: '/'}},

        {name: 'user.get',            title: loc._cf('premission', 'Get user(s)'),           isTranslatable: true, roles: 'userManager', ownerModule: name, menuItem: {label: loc._cf('menu', 'Users'),              isTranslatable: true, icon: 'users',           parent: 'administration', action: 'grid',    service: 'user'}},
        ...
        {name: 'session.get',         title: loc._cf('premission', 'Get session(s)'),        isTranslatable: true, roles: 'userManager', ownerModule: name, menuItem: {label: loc._cf('menu', 'Sessions'),           isTranslatable: true, icon: 'session',         parent: 'administration', action: 'grid',    service: 'session'}},
