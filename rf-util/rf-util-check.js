...
export function checkNotNullNotEmptyAndNotUndefined(value, options) {
  options = {
    method: v => !!v,
    statusCode: 500,
    message: loc => loc._('"%s" is null or empty', options?.paramTitle ?? 'value'),
    ...options
  };
...
export function checkParameterNotNullOrEmpty(value, options) {
  ...
  return checkUndefinedOrNotNullAndNotEmpty(
    ...
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is undefined, null or empty', options?.paramTitle ?? 'value'),
      ...options,
    }
  );
}
...
export function checkString(value, options) {
  options = {
    ...
    statusCode: 500,
    message: loc => loc._('"%s" is not a string', options?.paramTitle ?? 'value'),
    ...options
  };
...
export function checkParameterStringNotNullOrEmpty(value, options) {
  ...
  return checkNotNullNotEmptyAndNotUndefined(
    ...
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is missing, null, or empty.', options?.paramTitle ?? 'value'),
      ...options,
    }
  ) && checkString(
    value,
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is not a string.', options?.paramTitle ?? 'value'),
      ...options,
    }
  ) ;
}
...
export function checkParameterStringUndefinedOrNotNullAndNotEmpty(value, options) {
  ...
  return checkUndefinedOrNotNullAndNotEmpty(
    ...
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is null or empty', options?.paramTitle ?? 'value'),
      ...options,
    }
  ) && checkString(
    value,
...
export function checkValidUuid(value, options) {
  options = {
    ...
    statusCode: 500,
    message: loc => loc._('"%s" is not a valid UUID value', options?.paramTitle ?? 'value'),
    ...options
  };
...
export function checkParameterUuid(value, options) {
  ...
  return checkValidUuid(
    ...
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is not a valid UUID value', options?.paramTitle ?? 'value'),
      ...options,
    }
  );
}
...
export function checkParameterUuidList(value, options) {
  ...
  return checkValidUuidList(
    ...
    {
      statusCode: 400,
      message: loc => loc._('"%s" parameter is not a valid UUID list value', options?.paramTitle ?? 'value'),
      ...options,
    }
  );
}